...
const baseStyles =
  "inline-flex items-center justify-center font-medium rounded-full px-6 py-2 w-fit text-sm text-nowrap transition-colors hover:cursor-pointer";
...
type VariantFlags =
  ...
  | {
      ...
      destructive?: never;
      outlineDestructive?: never;
    }; // przypadek, gdy nie ma nic (default)
